...
const getMaxMinAvgIntensity = (array) => {
    ...
    let arrayTobeReturned = [
        {
            intensity : sorted[array.length - 1].Intensity,
            Time : 'Max Intensity (gCO2/Kwh)',

        },
        {
            intensity : sorted[0].Intensity,
            Time : 'Min Intensity (gCO2/Kwh)',

        },
        {
            intensity : sum/array.length,
            Time : 'Average Intensity (gCO2/Kwh)',
